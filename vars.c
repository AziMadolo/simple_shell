...
/**
 * check_chain - Checks if we should continue chaining based on the last command's status.
 * @info: The parameter struct containing shell information.
 * @buf: The character buffer.
 * @p: Address of the current position in the buffer.
 ...
 * @info: The parameter struct containing shell information.
 *
 * Return: 1 if variables are replaced, otherwise 0.
 */
 ...
 *
 * Return: 1 if the string is replaced, otherwise 0.
 */
...
int is_chain(info_t *info, char *buf, size_t *p)
{
	...
	{
		buf[j] = 0; /* Replace semicolon with null character. */
